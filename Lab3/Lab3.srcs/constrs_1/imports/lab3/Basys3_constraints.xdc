...
set_property PACKAGE_PIN R2 [get_ports {select}]					
...
#set_property PACKAGE_PIN P3 [get_ports {L[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {L[0]}]
#set_property PACKAGE_PIN N3 [get_ports {L[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {L[1]}]
#set_property PACKAGE_PIN P1 [get_ports {L[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {L[2]}]
#set_property PACKAGE_PIN L1 [get_ports {L[3]}]					
