...
HD_PWD='C:/Users/duggie/CPE133/Lab3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_sub_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_sub_display.tcl
