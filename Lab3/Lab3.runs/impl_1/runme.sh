...
HD_PWD='C:/Users/duggie/CPE133/Lab3/Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add_sub_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add_sub_display.tcl -notrace
